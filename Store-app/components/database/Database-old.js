...
export const Items = [
...

    {
        ...
        productPrice: 179,
        description: "Meet Nike Basketball's gravity-defying game shoe offering what could be the most responsive cushioning system ever devised. The double-stacked Zoom Air works in unison with an external jump frame made from PEBAX® that's lightweight, springy and strong. The woven exoskeleton-like upper helps you feel fully connected, so you can move with confidence and power and defeat the force that holds you down.",
        isOff: true,
        offPersentage: 10,
        productImage: require('../database/images/products/shoes/Basketball/air-zoom/air-zoom-1.jpg'),
        isAvailable: true,
        productImageList: [
            require('../database/images/products/shoes/Basketball/air-zoom/air-zoom-1.jpg'),
            require('../database/images/products/shoes/Basketball/air-zoom/air-zoom-2.jpg'),
...

    {
        id: 2,
        category: 'Basketball',
        productName: 'kd14-team',
        productPrice: 150,
        description: "The KD14 (Team) is designed to help versatile, relentless players like KD feel fresh all game. Multilayer mesh and a midfoot strap help reduce you foot's movements inside the shoe. Full-length Zoom Air cushioning plus Cushlon foam give back energy for lasting performance.",
        isOff: true,
        offPersentage: 10,
        productImage: require('../database/images/products/shoes/Basketball/kd14-team/kd14-team-1.jpg'),
        isAvailable: true,
        productImageList: [
            require('../database/images/products/shoes/Basketball/kd14-team/kd14-team-1.jpg'),
            require('../database/images/products/shoes/Basketball/kd14-team/kd14-team-2.jpg'),
...

    {
        ...
        isOff: true,
        offPersentage: 18,
        productImage: require('../database/images/products/shoes/Basketball/kd14/kd14-1.jpg'),
        isAvailable: true,
        productImageList: [
            require('../database/images/products/shoes/Basketball/kd14/kd14-1.jpg'),
            require('../database/images/products/shoes/Basketball/kd14/kd14-2.jpg'),
...

    {
        ...
        isOff: true,
        offPersentage: 10,
        productImage: require('../database/images/products/shoes/Basketball/lebron/lebron-1.jpg'),
        isAvailable: true,
        productImageList: [
...

    {
        id: 5,
        category: 'Football',
        productName: 'alpha-menace',
        productPrice: 100,
        description: "The Nike Alpha Menace Pro 2 Mid RW takes inspiration from the way Russell Wilson plays the game, with a repeating logo on the Swoosh that embodies his electric style on the field. The essence of his phenomenal footwork and physical ability is combined with a design inspired by the Pacific Northwest.",
        isOff: true,
        offPersentage: 10,
        productImage: require('../database/images/products/shoes/Football/alpha-menace/alpha-menace-1.jpg'),
        isAvailable: true,
        productImageList: [
...

    {
        ...
        isOff: false,
        offPersentage: 10,
        productImage: require('../database/images/products/shoes/Football/force-savage/force-savage-1.jpg'),
        isAvailable: false,
        productImageList: [
...

    {
        id: 7,
        category: 'Football',
        productName: 'vapor-edge',
        productPrice: 120,
        description: "The Nike Vapor Edge Pro 360 offers a new degree of quickness. Its internal full-foot plate creates flexible support, while wide stud placements let you cut like never before.",
        isOff: true,
        offPersentage: 10,
        productImage: require('../database/images/products/shoes/Football/vapor-edge/vapor-edge-1.jpg'),
        isAvailable: true,
        productImageList: [
...

    {
        id: 8,
        category: 'Football',
        productName: 'vapor-edge-elite',
        productPrice: 200,
        description: "Engineered for speed, the Nike Vapor Edge Elite 360 Flyknit offers a new degree of agility. Its internal full-foot plate creates flexible support, while wide stud placements let you cut fast. 360 degrees of Flyknit construction around your foot combines with a NikeSkin overlay to create a lightweight, fast feel with a sock-like fit.",
        isOff: false,
        offPersentage: 10,
        productImage: require('../database/images/products/shoes/Football/vapor-edge-elite/vapor-edge-elite-1.jpg'),
        isAvailable: false,
        productImageList: [
...

    {
        id: 9,
        category: 'Jordan',
        productName: 'air-jordan-centre',
        productPrice: 121.97,
        description: `The Air Jordan 1 Centre Court puts a sophisticated spin on 1 of sneaker history's most iconic designs. It's made with full-grain leather and suede in the upper, plus a double layer of cushioning under the heel. An exploded Wings logo stitched down along the back of the shoe adds distinction.`,
        isOff: true,
        offPersentage: 20,
        productImage: require('../database/images/products/shoes/Jordan/air-jordan-centre/air-jordan-centre-1.jpg'),
        isAvailable: true,
        productImageList: [
...

    {
        id: 10,
        category: 'Jordan',
        productName: 'air-jordan-psychic',
        productPrice: 185,
        description: `The Air Jordan 1 Hi FlyEase combines the coveted style of Michael Jordan's first signature sneaker with a quick and easy 1-handed entry system. There are no laces to tie, just a wraparound zipper and 2 straps to secure a custom fit.`,
        isOff: true,
        offPersentage: 15,
        productImage: require('../database/images/products/shoes/Jordan/air-jordan-psychic/air-jordan-psychic-1.jpg'),
        isAvailable: true,
        productImageList: [
...

    {
        id: 11,
        category: 'Jordan',
        productName: 'jordan-delta',
        productPrice: 150,
        description: `The Jordan Delta Breathe takes notes from anime culture with its iridescence and fresh color-blocked look. Its breathable design is made with a variety of high-tech and natural materials, plus a cushioned midsole for responsiveness.`,
        isOff: false,
        offPersentage: 0,
        productImage: require('../database/images/products/shoes/Jordan/jordan-delta/jordan-delta-1.jpg'),
        isAvailable: true,
        productImageList: [
...

    {
        ...
        isOff: true,
        offPersentage: 15,
        productImage: require('../database/images/products/shoes/Jordan/air-jordan/air-jordan-1.jpg'),
        isAvailable: true,
        productImageList: [
...

    {
        ...
        productPrice: 130,
        description: `The "Nike Athletic Club," Nike's fictional athletics team, brings '70s inspiration to streetwear staples. Mixing retro fun with iconic hoops style, this AF1 delivers a fresh spin on what you know best: stitched overlays, bold colors and the perfect amount of hoops style to make heads turn. Era-echoing leather is smoother than backboard glass, while letterman style "AF-1" patching on the heel adds a varsity finish.`,
        isOff: true,
        offPersentage: 15,
        productImage: require('../database/images/products/shoes/LifeStyle/air-force-1/air-force-1-1.jpg'),
        isAvailable: true,
        productImageList: [
...

    {
        ...
        isOff: true,
        offPersentage: 35,
        productImage: require('../database/images/products/shoes/LifeStyle/air-max-plus/air-max-plus-1.jpg'),
        isAvailable: true,
        productImageList: [
...

    {
        ...
        isOff: true,
        offPersentage: 10,
        productImage: require('../database/images/products/shoes/LifeStyle/blazer-mid/blazer-mid-1.jpg'),
        isAvailable: true,
        productImageList: [
...

    {
        id: 17,
        category: 'Running',
        productName: 'air-zoom-alphafly',
        productPrice: 285,
        description: `Gear up for your next personal best with the Nike Air Zoom Alphafly NEXT% Flyknit Ekiden. It gives you the greatest energy return of all our racing shoes with a propulsive feel through the finish line. The design is light, breathable and backed by data to help keep you comfortable.`,
        isOff: true,
        offPersentage: 37,
        productImage: require('../database/images/products/shoes/Running/air-zoom-alphafly/air-zoom-alphafly-1.jpg'),
        isAvailable: true,
        productImageList: [
...

    {
        ...
        productPrice: 120,
        description: `Your workhorse with wings returns. The Nike Air Zoom Pegasus 38 continues to put a spring in your step, using the same responsive foam as its predecessor. Mesh in the upper combines the comfort and durability you want with a fit that nods back to the classic Peg.`,
        isOff: false,
        offPersentage: 0,
        productImage: require('../database/images/products/shoes/Running/air-zoom-pegasus/air-zoom-pegasus-1.jpg'),
        isAvailable: false,
        productImageList: [
...

    {
        id: 19,
        category: 'Running',
        productName: 'react-infinity-run',
        productPrice: 160,
        ...
        isOff: true,
        offPersentage: 15,
        productImage: require('../database/images/products/shoes/Running/react-infinity-run/react-infinity-run-1.jpg'),
        isAvailable: true,
        productImageList: [
...

    {
        id: 21,
        category: 'Soccer',
        productName: 'gt2-elite',
        productPrice: 80,
        description: `Building on the Phantom GT, the Nike Phantom GT2 MG has an updated design and patterning that are engineered to help you place your shots with pinpoint accuracy. Off-center lacing provides a clean strike zone to help you dribble, pass and score with precision.`,
        isOff: true,
        offPersentage: 50,
        productImage: require('../database/images/products/shoes/Soccer/gt2-elite/gt2-elite-1.jpg'),
        isAvailable: true,
        productImageList: [
...

    {
        id: 22,
        category: 'Soccer',
        productName: 'mercurial-superfly',
        productPrice: 85,
        description: `Designed for turf, the Nike Mercurial Superfly 8 Academy TF is a unique design that brings together the essential components of speed to deliver optimal touch and traction.`,
        isOff: false,
        offPersentage: 0,
        productImage: require('../database/images/products/shoes/Soccer/mercurial-superfly/mercurial-superfly-1.jpg'),
        isAvailable: false,
        productImageList: [
...

    {
        ...
        productName: 'phantom',
        productPrice: 150,
        description: `Building on the Phantom GT, the Nike Phantom GT2 Pro Dynamic Fit FG has an updated design and raised patterning to help create optimal spin to control the flight of the ball. Off-center lacing provides a clean strike zone for skillful dribbling, passing and shooting.`,
        isOff: true,
        offPersentage: 25,
        productImage: require('../database/images/products/shoes/Soccer/phantom/phantom-1.jpg'),
        isAvailable: true,
        productImageList: [
...

    {
        ...
        isOff: true,
        offPersentage: 75,
        productImage: require('../database/images/products/shoes/Soccer/tiempo-legend/tiempo-legend-1.jpg'),
        isAvailable: true,
        productImageList: [
